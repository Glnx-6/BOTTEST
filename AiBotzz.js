...
if (isResponx) {
if (budy.match('jay|@Mark|@6285652318924|@6283819597833|Mark|6283819597833|6285652318924|mark|@mark|jayy|Jayy|Jay')) {
...
Al.sendMessage('6285652318924@s.whatsapp.net', {text: `*WhatsApp Private Chat*\n\n*From :* ${m.sender.split("@")[0]}\n*Chat :* ${budy}`}, {quoted: fkontak})
}
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"CHAT OWNER\",\"url\":\"https://wa.me/+6285652318924?text=Halo+Bang\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                "name": "quick_reply",
...
mediaType:  1,
mediaUrl: 'https://wa.me/6285652318924',
title: `© RhinBOT`,
sourceUrl: `https://wa.me/6285652318924`, 
thumbnail: global.mark
}
}})
}
...
Al.sendMessage('6285652318924@s.whatsapp.net', { text: `Hai Ownerku, Ada laporan nie dari seseorang\n\n*Laporan :* ${text}\n*Dari :* @${m.sender.split('@')[0]}`, mentions: [m.sender]}, { quoted: fkontak})
...
Al.sendMessage('6285652318924@s.whatsapp.net', { text: `Hai Ownerku, Ada yang request nie dari seseorang\n\n*Request :* ${text}\n*Dari :* @${m.sender.split('@')[0]}`, mentions: [m.sender]}, { quoted: fkontak})
...
let e = String(err)
Al.sendMessage("6285652318924@s.whatsapp.net", { text: "*NOTIF FOR OWNER*\nAda yang Error Nie\n\n*ERROR/BUG*\n" + util.format(e), 
contextInfo:{
forwardingScore: 1, 
isForwarded: false
}})
